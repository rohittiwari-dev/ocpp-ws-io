...
| `transport`           | `TransportConnector`            | ws default | Custom transport connector (e.g. µWebSockets.js).   |
...
| `transportServer`    | `TransportServer`               | ws default | Custom transport server instance (e.g. µWebSockets.js).                                                                                        |
