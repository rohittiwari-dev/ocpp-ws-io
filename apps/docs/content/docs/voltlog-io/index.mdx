...
**Voltlog-io** is a powerful structured logger designed for high-throughput systems like IoT platforms, WebSocket servers, and microservices. It is the default logging engine for `ocpp-ws-io` but works perfectly as a standalone logger in any TypeScript/JavaScript project.
...
Voltlog comes strictly typed and batteries-included.
