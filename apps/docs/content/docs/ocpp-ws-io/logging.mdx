...
**ocpp-ws-io** includes a structured logging system powered by **[voltlog-io](https://www.npmjs.com/package/voltlog-io)**. It provides real-time traffic inspection, performance monitoring, and integration with external logging services.
