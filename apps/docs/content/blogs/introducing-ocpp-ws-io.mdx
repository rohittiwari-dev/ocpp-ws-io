...
- **Protocol Support**: Handles OCPP 1.6, 2.0.1, and upcoming 2.1.
...
Explore our [documentation](/docs) to learn more, or browse the full [ecosystem packages](/docs/packages) — including the Protocol Proxy, Smart Charge Engine, CLI tools, and Browser Simulator.
