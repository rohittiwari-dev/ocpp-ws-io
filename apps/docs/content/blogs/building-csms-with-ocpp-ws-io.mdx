...
image: https://images.unsplash.com/photo-1554306274-f23873d9a26c?auto=format&fit=crop&q=80&w=1000
...
| Goal | Guide |
|------|-------|
| Distribute grid power across chargers | [Smart Charge Engine](/docs/smart-charge-engine) |
| Bridge legacy 1.6 chargers to a 2.1 CSMS | [Protocol Proxy](/docs/protocol-proxy) |
| Test from the terminal | [CLI Toolbox](/docs/cli) |
| Visualize sessions in the browser | [Simulator](/docs/simulator) |
| Explore all packages | [Packages](/docs/packages) |
