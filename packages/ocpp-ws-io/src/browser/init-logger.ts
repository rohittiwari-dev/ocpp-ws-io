/**
 * Browser-safe internal utility to initialize a logger from LoggingConfig.
 *
 * Uses `voltlog-io/client` — the browser-only entry point — instead of the
 * full `voltlog-io` package which pulls in Node.js-specific transports.
 *
...
export function initLogger(
  ...
  // Build default voltlog-io (browser-safe)
